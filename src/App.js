...
//     """
//     full_path = os.path.join(app.config['UPLOAD_FOLDER'], path)  # Full path for the file inside 'uploads'
//     print(f"Preparing audio file: {path}")  # Log the file being processed

//     ext = os.path.splitext(full_path)[1].lower()
//     wav_file = os.path.splitext(full_path)[0] + '_converted.wav'  # Add '_converted' to avoid overwriting

//     try:
//         if ext == '.wav':  # Check if it's already a WAV file
...
//         audio.export(wav_file, format='wav', codec='pcm_s16le')  # Export as 16-bit PCM WAV
...
//     data = request.json
//     audio_file_path = "uploads/"+data.get("audioFilePath")
